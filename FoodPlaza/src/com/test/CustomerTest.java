	...
	public static void main(String[] args) throws Exception{
		...
		while(true) {
			...
			case 2 :
				...
				String oldEmailID = br.readLine();

				b = customerobj.updateCustomerById(new Customer(customerName,customerEmailID,customerPassword,customerContactNo,customerAddress),oldEmailID);
